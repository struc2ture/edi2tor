...
void test_text_line_make_dup_regular_string(UT_State *s)
{
    char *str = "Hello!!!";
    int len = strlen(str);
...
void test_text_line_make_dup_empty_string(UT_State *s)
{
    char *str = "";
    int len = strlen(str);
...
void unit_tests_run(Text_Buffer *log_buffer, bool break_on_failure)
{
    ...
    test_text_line_make_dup_regular_string(&s);
    test_text_line_make_dup_empty_string(&s);
